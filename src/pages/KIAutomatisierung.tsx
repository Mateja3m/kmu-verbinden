            ...
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <div className="text-center space-y-6">
                ...
                <p className="text-xl md:text-2xl text-gray-200">
                  In Partnerschaft mit Evoya.ai - Ihrem Experten für KI-Lösungen
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  ...
                  <p>Automatisieren Sie repetitive Aufgaben und sparen Sie wertvolle Zeit mit massgeschneiderten KI-Lösungen von Evoya.ai.</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  ...
                  <p>Nahtlose Integration in Ihre bestehenden Systeme und Arbeitsabläufe durch erfahrene Experten.</p>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="text-center bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-sm rounded-xl p-8">
                  ...
                  <p className="mb-6">
                    Lassen Sie uns gemeinsam mit Evoya.ai Ihr Unternehmen in die Zukunft führen.
                  </p>
                  <Button 
