        ...
        <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4 py-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="hover:shadow-lg transition-shadow bg-white relative isolate overflow-hidden">
                <CardHeader>
              ...
              <Card className="hover:shadow-lg transition-shadow bg-white relative isolate overflow-hidden md:col-span-2 lg:col-span-3">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
