...
const EventKalender = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* KITS 2025 Banner */}
      <div className="bg-gradient-to-r from-swiss-darkblue to-swiss-red text-white py-12 px-4">
            ...
            <Card className="p-6 bg-white shadow-lg">
              ...
              <div className="space-y-4">
                {upcomingEvents.map(event => (
                  <div
                    key={event.id}
                    className="p-4 rounded-lg border border-gray-200 hover:border-swiss-red transition-colors"
                  >
