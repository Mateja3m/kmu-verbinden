      ...
      <DialogContent className="max-w-4xl max-h-[90vh]">
        ...
        <div className="w-full h-[70vh]">
          {loadError ? (
            ...
            <iframe
              src="https://uqxvvjdegwukvvrefkho.supabase.co/storage/v1/object/public/expert-images//Statuten%20des%20Schweizerischen%20KMU%20Vereins%20(SKV).docx.pdf#toolbar=0"
