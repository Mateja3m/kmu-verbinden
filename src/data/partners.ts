...
export const nationalPartners: FrontendPartner[] = [
  ...
  {
    id: "sd-treuhand",
    name: "SD Treuhand & Dienste",
    logo: "https://www.sdtreuhandunddienste.ch/wp-content/themes/sdtreuhandf2017/files/images/logo.png",
    website: "https://www.sdtreuhandunddienste.ch",
    description: "Treuhand, Buchhaltung und Steuerberatung",
  },
  {
...
export const regionalPartners: FrontendPartner[] = [
  {
    ...
    logo: "https://cdn.prod.website-files.com/620b69625cf399e569d2c9e6/62f26d021df59435d299d830_keller_logo_800.svg",
    website: "https://www.kit.ch",
  ...
  },
  {
    ...
    website: "https://www.webagentur-forster.ch",
  ...
  },
  {
    ...
    website: "https://geruestschweiz.ch",
    description: "Gerüstlösungen für Bauprojekte",
  },
  {
    id: "umzug-schweiz",
    name: "Umzug Schweiz 24",
...
export const cooperationPartners: FrontendPartner[] = [
  ...
  },
  {
    id: "wir-bank",
    name: "WIR Bank",
    logo: "https://www.wir.ch/typo3conf/ext/wir/Templates/Wir/Resources/Public/Icons/logo.svg",
    website: "https://www.wir.ch",
    description: "Innovative Finanzlösungen",
  },
  {
    id: "meinjurist",
    name: "meinJurist",
...
export const patronagePartners: FrontendPartner[] = [
  {
    ...
    logo: "https://a.storyblok.com/f/111983/2145x231/62b3dd2c58/energie-cluster-logo.png",
